    ...
    <div>
      ...
      <div className="divTop">
                  ...
                  <Dropdown as={ButtonGroup}>
                    ...
                    <Dropdown.Menu>
                      <Dropdown.Item onClick={handleShow2}>
                        Rotor pump - Centrífugas horizontales a eje libre
                      </Dropdown.Item>
                      <Dropdown.Item onClick={handleShow23}>
                        Rotor Pump - Centrífugas horizontales
                      </Dropdown.Item>
                      <Dropdown.Item onClick={handleShow24}>
                        WILO - SPU4 - Sumergibles 4
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                </div>
                  ...
                  <Dropdown as={ButtonGroup}>
                    ...
                    <Dropdown.Menu>
                      <Dropdown.Item onClick={handleShow4}>
                        2016- Connector- quick selection guide
                      </Dropdown.Item>
                      <Dropdown.Item onClick={handleShow20}>
                        Catálogo de conectores y accesorios ENE2021 (1)
                      </Dropdown.Item>
                      <Dropdown.Item onClick={handleShow21}>
                        KC_Jul2019_Global connectors catalog
                      </Dropdown.Item>
                      <Dropdown.Item onClick={handleShow22}>
                        Image
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                  ...
                  <Dropdown as={ButtonGroup}>
                    ...
                    <Dropdown.Menu>
                      <Dropdown.Item onClick={handleShow5}>
                        AMIAD -Semi-Automatic Filters Spanish - Filtros de malla
                      </Dropdown.Item>
                      <Dropdown.Item onClick={handleShow16}>
                        Filtros grava Yamit
                      </Dropdown.Item>
                      <Dropdown.Item onClick={handleShow17}>
                        SandSstorm - Filtros de grava
                      </Dropdown.Item>
                      <Dropdown.Item onClick={handleShow18}>
                        Sandstorm_double_chamber - Filtros de grava
                      </Dropdown.Item>
                      <Dropdown.Item onClick={handleShow19}>
                        Screen Guard - Filtros de malla
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                </div>
              ...
              <div className="cardProduct">
                ...
                <div className="boxCardProd">
                  ...
                  <Dropdown as={ButtonGroup}>
                    ...
                    <Dropdown.Menu>
                      <Dropdown.Item onClick={handleShow7}>
                        Catálogo de tuberias flexibles ENE21
                      </Dropdown.Item>
                      <Dropdown.Item onClick={handleShow14}>
                        NMC Junior Pro
                      </Dropdown.Item>
                      <Dropdown.Item onClick={handleShow15}>
                        NMC PRO CONTROLLER
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
              ...
              <div className="cardProduct">
                ...
                <div className="boxCardProd">
                  ...
                  <Dropdown as={ButtonGroup}>
                    ...
                    <Dropdown.Menu>
                      <Dropdown.Item onClick={handleShow8}>
                        Catálogo de tuberias flexibles ENE21
                      </Dropdown.Item>
                      <Dropdown.Item onClick={handleShow11}>
                        MANUAL CONECTORES ROSCADOS FLEXNET
                      </Dropdown.Item>
                      <Dropdown.Item onClick={handleShow12}>
                        MANUAL DE MANEJO Y RECOLECCIÓN FLEXNET
                      </Dropdown.Item>
                      <Dropdown.Item onClick={handleShow13}>
                        MANUAL NETAFIX
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
              ...
              <div className="cardProduct">
                ...
                <div className="boxCardProd">
                  ...
                  <Dropdown as={ButtonGroup}>
                    ...
                    <Dropdown.Menu>
                      <Dropdown.Item onClick={handleShow9}>
                        Full valves catalog
                      </Dropdown.Item>
                      <Dropdown.Item onClick={handleShow10}>
                        Netafim Air Valves- Brochure
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                </div>
        ...
        <div className="containerProducts">
          <div className="cardProductMobile">
            <div className="divFlexs">
              <img
                className="imgCardProductMobile"
                src="images/maiz.jpg"
                alt=""
              />
              <div className="boxCardProd">
        ...
        >
          ...
          <Modal.Body>
            <iframe src="" className="ifr" title="This is a unique title" />
          </Modal.Body>
        </Modal>
